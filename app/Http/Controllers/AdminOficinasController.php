<?php namespace App\Http\Controllers;
	...
	class AdminOficinasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Quantidade de vagas disponíveis","name"=>"vagasdisponiveis"];
			$this->col[] = ["label"=>"Quantidade de vagas reservas","name"=>"vagasreservas"];
