<?php namespace App\Http\Controllers;
	...
	class AdminDenunciasconselhoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Assunto","name"=>"assunto"];
			$this->col[] = ["label"=>"Mensagem","name"=>"mensagem"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nome','name'=>'nome','type'=>'text','validation'=>'required|min:1|max:100','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:100|email|unique:denunciasconselho','width'=>'col-sm-10','placeholder'=>'Por favor digite um endereço de e-mail válido'];
			...
			//$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:denunciasconselho','width'=>'col-sm-10','placeholder'=>'Por favor digite um endereço de e-mail válido'];
