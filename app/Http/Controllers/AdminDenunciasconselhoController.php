<?php namespace App\Http\Controllers;
	...
	class AdminDenunciasconselhoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:denunciasconselho","placeholder"=>"Por favor digite um endereço de e-mail válido"];
