<?php namespace App\Http\Controllers;
	...
	class AdminGrupofamiliarController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Dependentes","name"=>"familia"];
			$this->col[] = ["label"=>"Endereço","name"=>"endereco"];
			$this->col[] = ["label"=>"Bairro","name"=>"bairro"];
			$this->col[] = ["label"=>"Data de nascimento","name"=>"datanascimento"];
			$this->col[] = ["label"=>"PAIF","name"=>"paif"];
